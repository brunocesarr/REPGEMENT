...
<html lang="en">
  ...
  <head>
    ...
    <title>REPGEMENT - Gráficos</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Gráfico de Despesas Mensal da República</div>
            <div class="card-body">
              <canvas id="myAreaChart" width="100%" height="30"></canvas>
            </div>
            <div class="card-footer small text-muted">Atualizado ontem, 21 de Novembro de 2018</div>
          </div>
